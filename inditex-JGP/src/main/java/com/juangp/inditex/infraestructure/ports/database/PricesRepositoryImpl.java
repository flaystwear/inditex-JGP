package com.juangp.inditex.infraestructure.ports.database;
...
public class PricesRepositoryImpl implements FindPricesPort {

    private final PricesRepository pricesRepository;

    private final PriceEntityMapper priceEntityMapper;
    private static final Logger logger = LoggerFactory.getLogger(PricesRepositoryImpl.class);
